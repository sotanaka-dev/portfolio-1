...
<div x-show="open" x-transition.opacity.scale.120.duration.300ms x-cloak class="full-overlay">
    <div x-on:click.outside="open=false" class="modal-dialog">
        <p class="modal-dialog__message">
            {{ $message }}
        </p>
        <div class="modal-dialog__btn-wrap">
            <button x-on:click="open=false" wire:click="pressedExecBtn" class="modal-dialog__exec link">実行</button>
